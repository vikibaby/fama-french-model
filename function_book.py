...
#setp1
def generate_stock_price(stock_basic_df,start_date_str,end_date_str,shift_size,columns_str = "date,code,close,pbMRQ,isST"):
    ...
    stock_basic_df = pd.read_csv("tmt_stock_basic.csv", encoding='utf_8')

    generate_stock_price(stock_basic_df,start_date,end_date,shift_size,columns_str = "date,code,close,pbMRQ,isST")
...
#step2
def generate_stock_details(stock_price_df,quarter_date_list):
